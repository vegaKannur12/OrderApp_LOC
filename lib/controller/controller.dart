...
import 'package:marsproducts/model/accounthead_model.dart';
import 'package:marsproducts/model/productCompany_model.dart';
import 'package:marsproducts/model/productUnitsModel.dart';
import 'package:marsproducts/model/productsCategory_model.dart';
import 'package:marsproducts/model/registration_model.dart';
import 'package:marsproducts/model/settings_model.dart';
import 'package:marsproducts/model/sideMenu_model.dart';
import 'package:marsproducts/model/userType_model.dart';
import 'package:marsproducts/model/verify_registrationModel.dart';
import 'package:marsproducts/model/wallet_model.dart';
import 'package:marsproducts/screen/ADMIN_/adminModel.dart';
...
class Controller extends ChangeNotifier {
  ...
  Text pl = const Text("");
  Text loma = const Text(" ");
  Text cusMark = const Text(" ");
  String cust_lat = "";
  String cust_longi = "";
  bool lomaLoad = false;
...
///////////////////////insertreturnMasterandDetailsTable//////////////////////////////
  ...
  insertStaffLogDetails(
    ...
    var logdata = await OrderAppDB.instance
        .insertStaffLoignDetails(sid, sname, datetime, track);
    notifyListeners();
  }
...
/////////////...........tO mARK staff location.........////////////
                  ...
                  if (result[1].length > 0) {
                    ...
                    for (int i = 0; i < result[0].length; i++) {
                      for (var item in jsonDe) {
                        ...
                        Map body = {'cid': cid, 'rm': jsonString};
                        // ignore: avoid_print
  ...
  uploadLocation(BuildContext context) {
    NetConnection.networkConnection(context, "").then((value) async {
      ...
      if (value == true) {
        try {
          var result = await OrderAppDB.instance.selectLocationTable();
          if (result.length > 0) {
            // isUpload = true;
            String jsonE = jsonEncode(result);
            var jsonDe = jsonDecode(jsonE);
    ...
    OrderAppDB.instance.selectLocationTable();
  }

/////////////...........Save staff login,periodically,logout location.........////////////
  location(
      String place,
      String datetime,
      String datetoday,
    ...
    try {
      ...
      if (map != null) {
        ...
        await OrderAppDB.instance.locationDetailsTable(
            ...
            activity,
            1);
        print("Inserted to loc table after api insert");
      } else {
        await OrderAppDB.instance.locationDetailsTable(
            place,
            sid.toString(),
            ...
            activity,
            0);
        print("Inserted to loc table after api insert fail");
      }
      // ignore: avoid_print
...
/////////////...........check if location already Marked.........////////////
  selectmarked(BuildContext context, String custid) async {
    print("selentry");
    ...
    try {
      ...
      if (result.length > 0) {
        ...
        for (int i = 0; i < result.length; i++) {
          ...
          String dateqry = DateFormat('dd-MM-yyyy').format(dateqry1);
          print("dateqry: $dateqry , $datenow");
          if (dateqry.toString().trim() == datenow.toString().trim()) {
            locMarkLoading = false;
            marked = "Location Already Marked";
            loma = Text("");

            notifyListeners();
            // print("selentryloo[] $marked");
            break;
          }
        }
      } else {
...
/////////////...........Check distnce btwn custmrloc and stafflocation.........////////////
...
/////////////...........clear cutmr location marked msg.........////////////
  clearCUSMarkText() {
    print("clearedLOMA");
    cusMark = Text(" ");
    notifyListeners();
  ...
  /////////////...........Add location of customer.........////////////
  mark_custLoc(BuildContext context, String custid) async {
    bool serviceEnabled;
    LocationPermission permission;
    determineLoad = true;
    notifyListeners();
